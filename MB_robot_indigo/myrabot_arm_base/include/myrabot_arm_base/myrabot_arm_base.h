#ifndef myrabot_arm_base_H
#define myrabot_arm_base_H
...
geometry_msgs::Point directa(myrabot_arm_base::Servos posicion_servos_0, int inclinacion_pinza)
  {
...
geometry_msgs::Point directa(myrabot_arm_base::Servos posicion_servos_0, int inclinacion_pinza, std::string elemento_final)
  {
  ...
  myrabot_arm_base::WriteServos inversa(geometry_msgs::Point destino, int inclinacion_pinza, myrabot_arm_base::Servos posicion_servos_0, int velocidad) 
  {
	...
	myrabot_arm_base::Servos posicion_servos_1;
	myrabot_arm_base::Servos velocidad_servos;
	myrabot_arm_base::Servos par_servos;	
	...
	myrabot_arm_base::Servos velocidad_servos_0;
	...
	myrabot_arm_base::WriteServos move_arm;			
...
myrabot_arm_base::WriteServos inversa(geometry_msgs::Point destino, int inclinacion_pinza, myrabot_arm_base::Servos posicion_servos_0, int velocidad, std::string elemento_final) 
  {
	...
	double alfa, alfa_0, alfa_1, beta, beta_a, beta_p, beta_pp, gamma, delta, delta_a, delta_p, epsilon;
	double z_p, z_p_0;
	double L_a, L;
	...
	epsilon = (inclinacion_pinza*PI)/180;
 	...
 	z_p_0 = sqrt(pow(z,2)+pow(x,2));
 
	alfa_0 = asin(Dx/z_p_0);
...
myrabot_arm_base::WriteServos controlPinza(myrabot_arm_base::Servos posicion_servos_1, myrabot_arm_base::Servos posicion_servos_0, myrabot_arm_base::Servos corriente_servos)
  {
	...
	myrabot_arm_base::WriteServos hand_arm;		
...
bool puntoAlcanzado(myrabot_arm_base::Servos posicion_servos_1, myrabot_arm_base::WriteServos posicion_servos_0, int precision)
  {
...
bool igualPosicion(myrabot_arm_base::Servos posicion_servos_1, myrabot_arm_base::WriteServos posicion_servos_0)
  {
...
desplazamiento dentroAlcance(geometry_msgs::Point destino, double orientacion, int inclinacion_pinza, myrabot_arm_base::Servos posicion_servos_0, int velocidad, std::string elemento_final)
  {				  	
...
geometry_msgs::Point home(myrabot_arm_base::Servos posicion_servos_0, myrabot_arm_base::Servos corriente_servos)
  { 
  	...
  	ros::Publisher hand_pub_=n.advertise<myrabot_arm_base::WriteServos>("hand_arm", 1);   //Publicación del topic "hand_arm" 	  
		...
		myrabot_arm_base::WriteServos inicio_brazo = inversa(punto_0, inclinacion_pinza, posicion_servos_0, 0);
	
		myrabot_arm_base::Servos posicion_servos_1;
		
		posicion_servos_1.pinza = 511;
	
		myrabot_arm_base::WriteServos inicio_pinza = controlPinza(posicion_servos_1, posicion_servos_0, corriente_servos);
...
geometry_msgs::Point home(myrabot_arm_base::Servos posicion_servos_0, myrabot_arm_base::Servos corriente_servos, std::string elemento_final)
  { 
  	...
  	ros::Publisher hand_pub_=n.advertise<myrabot_arm_base::WriteServos>("hand_arm", 1);   //Publicación del topic "hand_arm" 	  
		...
		myrabot_arm_base::WriteServos inicio_brazo = inversa(punto_0, inclinacion_pinza, posicion_servos_0, 0, elemento_final);
...
myrabot_arm_base::WriteServosTrajectory trayectoria(geometry_msgs::Point origen, geometry_msgs::Point destino, int inclinacion_pinza, myrabot_arm_base::Servos posicion_servos_0, int velocidad, std::string elemento_final)
  { 
	double lambda = 0;
	
	myrabot_arm_base::Servos posicion_servos_i = posicion_servos_0;
	...
	trayecto.trayectoria = std::vector<myrabot_arm_base::WriteServos>(puntos);
	...
	{	
		...
		myrabot_arm_base::Servos posicion_servos_i = trayecto.trayectoria[i].posicion;
