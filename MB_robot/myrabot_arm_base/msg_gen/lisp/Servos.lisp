...
(cl:defmethod cl:initialize-instance :after ((m <Servos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myrabot_arm_base-msg:<Servos> is deprecated: use myrabot_arm_base-msg:Servos instead.")))

(cl:ensure-generic-function 'base-val :lambda-list '(m))
(cl:defmethod base-val ((m <Servos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrabot_arm_base-msg:base-val is deprecated.  Use myrabot_arm_base-msg:base instead.")
  (base m))

(cl:ensure-generic-function 'arti1-val :lambda-list '(m))
(cl:defmethod arti1-val ((m <Servos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrabot_arm_base-msg:arti1-val is deprecated.  Use myrabot_arm_base-msg:arti1 instead.")
  (arti1 m))

(cl:ensure-generic-function 'arti2-val :lambda-list '(m))
(cl:defmethod arti2-val ((m <Servos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrabot_arm_base-msg:arti2-val is deprecated.  Use myrabot_arm_base-msg:arti2 instead.")
  (arti2 m))

(cl:ensure-generic-function 'arti3-val :lambda-list '(m))
(cl:defmethod arti3-val ((m <Servos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrabot_arm_base-msg:arti3-val is deprecated.  Use myrabot_arm_base-msg:arti3 instead.")
  (arti3 m))

(cl:ensure-generic-function 'pinza-val :lambda-list '(m))
(cl:defmethod pinza-val ((m <Servos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrabot_arm_base-msg:pinza-val is deprecated.  Use myrabot_arm_base-msg:pinza instead.")
  (pinza m))
