  ...
  void mover(const myrabot_arm_base::WriteServos& move)
  {    
        ros::NodeHandle n;
        ...
        myrabot_arm_base::Servos position = move.posicion;
        myrabot_arm_base::Servos speed = move.velocidad;
        myrabot_arm_base::Servos torque = move.par;
  ...
  {      
        ...
        myrabot_arm_base::Servos position = pinza.posicion;
        myrabot_arm_base::Servos speed = pinza.velocidad;
        myrabot_arm_base::Servos torque = pinza.par;
  ...
  void pe(const sensor_msgs::JointState& pe)
  {
        ...
        ros::Publisher pose_pub_=n.advertise<myrabot_arm_base::ReadServos>("pose_arm", 1);  
         
        myrabot_arm_base::ReadServos estado;
